...
const getRefundOptions = () => {
  ...
  request.open("GET", "https://cors-anywhere.herokuapp.com/https://www.gabbarddesigns.com/snackcart/data/refund.json", true);
...
const getPaymentOptions = () => {
  let request = new XMLHttpRequest();
  request.open("GET", "https://cors-anywhere.herokuapp.com/https://www.gabbarddesigns.com/snackcart/data/pay.json", true);
  request.onload = function() {
    if (request.status >= 200 && request.status < 400) {
      // Success!
      let data = JSON.parse(request.responseText);
...
const importInventory = () => {
  let request = new XMLHttpRequest();
  request.open("GET", "https://cors-anywhere.herokuapp.com/https://www.gabbarddesigns.com/snackcart/data/inventory.json", true);
  request.onload = function() {
    if (request.status >= 200 && request.status < 400) {
      // Success!
      let data = JSON.parse(request.responseText);
